...
public class Service3Discovery {
	...
	private static class Service3Listener implements ServiceListener {
		...
		public void serviceAdded(ServiceEvent event) {
			System.out.println("\nService 3 Added: Manage Security Footage  " + event.getInfo());

		}

		@Override
		public void serviceRemoved(ServiceEvent event) {
			System.out.println("Service 3 Removed: Manage Security Footage   " + event.getInfo());
	...
	public static ServiceInfo run(String service_type) {
		...
		try {
			...
			// specified type
			Service3Listener msl = new Service3Listener();
